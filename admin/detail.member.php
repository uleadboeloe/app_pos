...
<div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak>
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8 bg-green-100">
        ...
        if(isset($_GET['rcode'])){
            ...
            $StrViewQuery="SELECT * from dbo_member where kode_member = '" . $_GET['rcode'] . "'";
            ...
            while($recView=mysqli_fetch_array($callStrViewQuery))
            {
                ...
                <div class="col-span-12 p-2 lg:col-span-12">
                    <div class="flex items-center justify-between py-2 px-4">
                        <h2 class="font-bold text-xl uppercase tracking-wide text-slate-700 dark:text-navy-100">Detail Member</h2>
                        <div class="flex">
                        ...
                        onclick="PrintDoc();">Print Kartu Member</button>                                                
                        </div>
                    </div>
                    ...
                    <div class="flex" id="PrintArea" style="display:none;">
                        <table width="100%" class="voucher-print">
                            <tr>
                                <td width="20%">
                                    <img src="<?php echo $recView['qrcode_member'];   ?>" width="100%">
                                </td>
                                <td width="80%">
                                    <div class="fontBold">No Member</div>
                                    <div class="fontMember"><?php echo $recView['kode_member'];   ?></div>
                                    <div class="fontBold">Nama Member</div>
                                    <div class="fontMember"><?php echo $recView['nama_member'];   ?></div>
                                </td>
                            </tr>
                        </table>
                    </div>     
                    ...
                    <div class="rounded-lg bg-white py-5 sm:py-6">
                        <div class="px-4 text-primary sm:px-5">                       
                            <div class="flex">
                                <div class="w-80 p-2"><img src="<?php echo $recView['qrcode_member'];   ?>" class="mt-3 w-80"></div>
                                <div class="w-full p-2">
                                    <div class="mt-3">
                                        <p class="text-indigo-300">Nama Member</p>
                                        <p class="text-3xl font-semibold tracking-wide"><?php echo $recView['nama_member'];   ?></p>
                                    </div>
                                    <div class="mt-3">
                                        <p class="text-indigo-300">Nomor Kontak</p>
                                        <p class="text-3xl font-semibold tracking-wide"><?php echo $recView['nomor_kontak'];   ?></p>
                                    </div>
                                    <div class="mt-3">
                                        <p class="text-indigo-300">Email Member</p>
                                        <p class="text-3xl font-semibold tracking-wide"><?php echo $recView['email_member'];   ?></p>
                                    </div>                                                                        
                                </div> 
                            </div>
                        </div>
