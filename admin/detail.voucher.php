...
<style>
    .voucher-bg {
        background-image: url('assets/images/logo_struk_.png');
...
<div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak>
    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8 bg-green-100">
        ...
        if(isset($_GET['rcode'])){
            ...
            $StrViewQuery="SELECT * from dbo_voucher where nomor_voucher = '" . $_GET['rcode'] . "'";
            ...
            while($recView=mysqli_fetch_array($callStrViewQuery))
            {
                ...
                <div class="col-span-12 p-2 lg:col-span-12">
                    <div class="flex items-center justify-between py-2 px-4">
                        <h2 class="font-bold text-xl uppercase tracking-wide text-slate-700 dark:text-navy-100">Detail Voucher</h2>
                        <div class="flex">
                        ...
                        onclick="PrintDoc();">Print Voucher</button>                                                
                        </div>
                    </div>

                    <div class="rounded-lg bg-white py-5 sm:py-6">
                        <div class="px-4 text-primary sm:px-5">
                            <div class="flex" id="PrintArea" style="display:none;">
                                <table width="100%" class="voucher-print">
                                    <tr>
                                        <td width="20%">
                                            <img src="<?php echo $recView['file_barcode'];   ?>" width="100%">
                                        </td>
                                        <td width="80%">
                                            <div class="fontBold">Nilai Voucher</div>
                                            <div class="NominalVoucher">Rp. <?php echo number_format($recView['nominal_voucher'],2);   ?></div>
                                            <div class="fontBold"><?php echo $recView['kode_voucher'];   ?></div>
                                            <div class="fontBolds">Syarat & Ketentuan</div>
                                            <ol class="list-syarat-ketentuan">
                                                <li>Syarat Pengunaan Voucher</li>
                                                <li>Syarat Pengunaan Voucher</li>
                                            </ol>
                                        </td>
                                    </tr>
                            ...
                            <div class="w-80 p-2"><img src="<?php echo $recView['file_barcode'];   ?>" class="mt-3 w-80"></div>
                            <div class="w-full p-2 text-right">
                                <div class="mt-3">
                                    <p class="text-indigo-300">Nilai Voucher</p>
                                    <p class="text-3xl font-semibold tracking-wide"><?php echo number_format($recView['nominal_voucher'],2);   ?></p>
                                </div>
                                <div class="mt-3">
                                    <p class="text-indigo-300">Syarat & Ketentuan</p>
                                    <p class="text-2xl font-semibold tracking-wide">Syarat Ketentuan Voucher</p>
                                </div>
                            </div>
                        </div>
                    </div>  
