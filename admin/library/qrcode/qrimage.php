 ...
 */
    ...
    class QRimage {
        ...
        public static function png($frame, $filename = false, $pixelPerPoint = 4, $outerFrame = 4, $saveandprint = FALSE, $forecolor = null, $backcolor = null, $logo = null)
        {
        ...
        public static function jpg($frame, $filename = false, $pixelPerPoint = 8, $outerFrame = 4, $q = 85, $forecolor = null, $backcolor = null) 
        {
            $image = self::image($frame, $pixelPerPoint, $outerFrame, $forecolor, $backcolor);
        ...
        private static function image($frame, $pixelPerPoint = 4, $outerFrame = 4, $forecolor = null, $backcolor = null) 
        {
            $h = count($frame);
            $w = strlen($frame[0]);
