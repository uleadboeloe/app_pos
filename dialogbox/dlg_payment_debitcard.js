$(function () {
  $("#DialogDebitCard").dialog({
    autoOpen: false,
    modal: true,
    width: 400,
    position: { my: "center top+50", at: "center top", of: window },
    open: function () {
      $("#DialogDebitCard").load(
        "dialogbox/dlg_payment_debitcard.php",
        function () {
          $("#4digit").focus();
        }
      );
    ...
    close: function () {
      $("#DialogDebitCard").html(""); // Clear content on close.
    },
    buttons: {
      OK: function () {
        ...
        if ($("#4digit").val().length != 4) {
          ...
          var log_description = "TENDER DEBIT: " + current_order_no;
