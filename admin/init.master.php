...
if(isset($_SESSION['SESS_user_id'])){
    ...
    $ftp_file = "/MASTERBC/Category.txt";
    $local_file = "fileupload/Category.txt";
    $local_filex = "fileupload/SubCategory.txt";
    $local_filexx = "fileupload/Departemen.txt";
    ...
    if($Filesize > 0){
        ...
        for($x=0;$x<$CountArrays;$x++){
            ...
            $strQuery="SELECT * FROM dbo_kategori WHERE kode_kategori = '" . $Kode . "' and nama_kategori = '" . $LabelName . "'";
