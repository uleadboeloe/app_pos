        ...
        if($varKdStore == $KodeStoreOffline){
            ...
            if(($varHarga0 > 0)&&($varUom != "")){
                ...
                if ($JumbarPrice === 0 ){
                    ...
                    ('$RandomCode','$varSkuBarang','$varSkuBarang','$varBarcodeBarang','$varUom','$varHarga0','$currdatedb','$datedb_plus_12_months','$datedb','ADMIN','1')";
            ...
            if(($varHarga1 > 0)&&($varUom1 != "")){          
                ...
                if ($JumbarPrice1 === 0 ){
                    ...
                    ('$RandomCode','$varSkuBarang','$varSkuBarang','$varBarcodeBarang1','$varUom1','$varHarga1','$currdatedb','$datedb_plus_12_months','$datedb','ADMIN','$varConv1')";
