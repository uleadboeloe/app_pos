    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="control-group">
                ...
                <div class="controls"><input class="span12 numeric-input4" id="4digit" type="number" value="" placeholder="Masukan 4 Digit Terakhir Kartu Debit" required /></div>
            </div>
            <div class="control-group">
                <label class="control-label" for="refno">Jenis Kartu Debit</label>
                <div class="controls"><input class="span12" id="jenis_kartu" type="text" value="" placeholder="Masukan Jenis Kartu Debit" required/></div>
            </div>
            <div class="control-group">
                <label class="control-label" for="refno">Reference Number</label>
                <div class="controls"><input class="span12 numeric-input6" id="refno" type="text" value="" placeholder="Masukan Nomor Reff" required/></div>
            </div>
            <div class="control-group">
        ...
        $(document).on("keydown", "input, select, textarea", function(e) {
            if (e.key === "Enter") {
                ...
                if (index !== -1 && index < inputs.length - 1) {
                    ...
                    $("#DialogDebitCard").closest(".ui-dialog").find(".ui-dialog-buttonset button:contains('OK')").trigger("click");
                }
            }
        });
