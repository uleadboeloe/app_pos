    ...
    <main class="main-content w-full px-[var(--margin-x)] pb-8 bg-green-100">
        <div class="col-span-12 p-2 lg:col-span-12">
            <div class="flex items-center justify-between py-2 px-4">
                <h2 class="font-bold text-xl uppercase tracking-wide text-slate-700 dark:text-navy-100">Setup Mesin EDC</h2>
            </div>

            <form name="formProses" name="frmMasterProduk" id="frmMasterProduk" method="post" action="proses-edc">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-5">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-1">
                                        <label class="block">
                                            <span class="text-purple-500 font-bold">Nama Mesin EDC <div class="badge rounded-full bg-primary/10 text-primary dark:bg-accent-light/15 dark:text-accent-light">Wajib</div></span>
                                            <span class="relative mt-1.5 flex">						
                                                <input placeholder="Masukan Nama Mesin EDC" type="text" id="txtNamaMesin" name="txtNamaMesin" required
        ...
        <div class="col-span-12 p-2 lg:col-span-12">
            <div class="flex items-center justify-between py-2 px-4">
                <h2 class="font-bold text-xl uppercase tracking-wide text-slate-700 dark:text-navy-100">List Mesin EDC</h2>
            </div>
            <div class="card p-5 mt-3">
                <table id="table1" class="is-hoverable w-full" width="100%">     
                    ...
                    <tr>
                        ...
                        <th class="whitespace-nowrap bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Nama Mesin Edc</th>
                        ...
                        <th class="whitespace-nowrap bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Posting Date</th>
                    ...
                    <?php
                    /*==========================*/
                    $StrViewQuery="SELECT * from dbo_mesin_edc where fl_active = 1";
                    ...
                    while($recView=mysqli_fetch_array($callStrViewQuery))
                    {
                        ...
                        $NamaMesin = $recView['nama_mesin'];
                        $BankPenerbit = $recView['bank_penerbit'];
                        $PostingDate = $recView['posting_date'];
                        $PostingUser = $recView['posting_user'];
                        $Status = $recView['fl_active'];
                        ?>
                        <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"><?php   echo $KodeStore; ?></td>     
                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"><a href="detail-edc@<?php   echo $RandomCode;   ?>" class="font-bold text-primary hover:text-orange-500"><?php   echo $NamaMesin; ?></a></td>     
